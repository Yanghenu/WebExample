...
const localuser = urlParams.get('id');
(function () {

    var accessToken = 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..MfsiUL6yBNpcZEjmXA6plLURtmxVqeSIhdphozGKQakCDXv58C7fE_yVhILX55Ys';
    // Connect to the SignalR Hub
    var connection = new signalR.HubConnectionBuilder()
        .withUrl("https://192.168.8.110:8091/myHub")  // Specify the Hub endpoint
        .withAutomaticReconnect()
        .withHubProtocol(new signalR.JsonHubProtocol())
        .configureLogging(signalR.LogLevel.Information)
        .build();
    connection.serverTimeoutInMilliseconds = 6000000000;
    ...
    //消息通知
    window.remind = function (message) {
        ...
        if ("Notification" in window) {
            ...
            Notification.requestPermission().then(function (permission) {
                if (permission === "granted") {
                    // 创建通知
                    var notification = new Notification('您有新消息', { body: message });
            ...
            console.log('该浏览器不支持 Notification API');
        }
    }
    ...
    window.insertMessage = function () {
        ...
        connection.invoke("SendMessage", localuser, msgText).then(function () {
